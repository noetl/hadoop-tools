...
cd /usr/lib
sudo curl -O https://s3-us-west-2.amazonaws.com/noetl-provisioning-us-west-2/emr-4.7.1/hive.tar.gz
...
cd /usr/lib
sudo curl -O https://s3-us-west-2.amazonaws.com/noetl-provisioning-us-west-2/emr-4.7.1/tez.tar.gz
echo "Installing Tez...."
...
cd /tmp
sudo curl -O https://s3-us-west-2.amazonaws.com/noetl-provisioning-us-west-2/emr-4.7.1/apps-tez-tez.tar.gz
